...
class IndexView(ListView):
    model = Role
    template_name = 'roster/base.html'

class LeaveListView(LoginRequiredMixin, ListView):
    """Leave List View."""

    model = Leave
    template_name = "roster/leave_list.html"
    login_url = "login"
...
class LeaveDetailView(LoginRequiredMixin, DetailView):
    ...
    model = Leave
    template_name = "roster/leave_detail.html"
    login_url = "login"
...
class LeaveUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = "roster/leave_edit.html"
    login_url = "login"
...
class LeaveDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = Leave
    template_name = "roster/leave_delete.html"
...
class LeaveCreateView(LoginRequiredMixin, FormView):
    ...
    template_name = "roster/leave_new.html"
    success_url = reverse_lazy("leave_list")
    login_url = "login"
...
class RoleListView(LoginRequiredMixin, ListView):
    ...
    model = Role
    template_name = "roster/role_list.html"
    login_url = "login"
...
class RoleDetailView(LoginRequiredMixin, DetailView):
    ...
    model = Role
    template_name = "roster/role_detail.html"
    login_url = "login"
...
class RoleUpdateView(LoginRequiredMixin, UpdateView):
    ...
    model = Role
    fields = ("role_name",)
    template_name = "roster/role_edit.html"
    login_url = "login"
...
class RoleDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = Role
    template_name = "roster/role_delete.html"
...
class RoleCreateView(LoginRequiredMixin, CreateView):
    ...
    model = Role
    template_name = "roster/role_new.html"
    fields = ("role_name",)
    login_url = "login"
...
class ShiftDetailView(LoginRequiredMixin, DetailView):
    ...
    model = Shift
    template_name = "roster/shift_detail.html"
    login_url = "login"
...
class ShiftUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = "roster/shift_edit.html"
    login_url = "login"
...
class ShiftDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = Shift
    template_name = "roster/shift_delete.html"
...
class ShiftCreateView(LoginRequiredMixin, CreateView):
    ...
    model = Shift
    template_name = "roster/shift_new.html"
    fields = ("shift_type", "day_group", "max_staff")
    login_url = "login"
...
class ShiftRuleListView(LoginRequiredMixin, ListView):
    ...
    model = ShiftRule
    template_name = "roster/shift_rule_list.html"
    login_url = "login"
...
class ShiftRuleDetailView(LoginRequiredMixin, DetailView):
    ...
    model = ShiftRule
    template_name = "roster/shift_rule_detail.html"
    login_url = "login"
...
class ShiftRuleUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = "roster/shift_rule_edit.html"
    login_url = "login"
...
class ShiftRuleDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = ShiftRule
    template_name = "roster/shift_rule_delete.html"
...
class ShiftRuleCreateView(LoginRequiredMixin, CreateView):
    ...
    model = ShiftRule
    template_name = "roster/shift_rule_new.html"
    fields = ("shift_rule_name", "shift")
    login_url = "login"
...
class ShiftRuleRoleListView(LoginRequiredMixin, ListView):
    ...
    model = ShiftRuleRole
    template_name = "roster/shift_rule_role_list.html"
    login_url = "login"
...
class ShiftRuleRoleDetailView(LoginRequiredMixin, DetailView):
    ...
    model = ShiftRuleRole
    template_name = "roster/shift_rule_role_detail.html"
    login_url = "login"
...
class ShiftRuleRoleUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = "roster/shift_rule_role_edit.html"
    login_url = "login"
...
class ShiftRuleRoleDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = ShiftRuleRole
    template_name = "roster/shift_rule_role_delete.html"
    success_url = reverse_lazy("shift_rule_list")
    login_url = "login"
...
class ShiftRuleRoleCreateView(LoginRequiredMixin, CreateView):
    ...
    model = ShiftRuleRole
    template_name = "roster/shift_rule_role_new.html"
    fields = ("role", "count")
    login_url = "login"
...
class StaffRuleListView(LoginRequiredMixin, ListView):
    ...
    model = StaffRule
    template_name = "roster/staff_rule_list.html"
    login_url = "login"
...
class StaffRuleDetailView(LoginRequiredMixin, DetailView):
    ...
    model = StaffRule
    template_name = "roster/staff_rule_detail.html"
    login_url = "login"
...
class StaffRuleUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = "roster/staff_rule_edit.html"
    login_url = "login"
...
class StaffRuleDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = StaffRule
    template_name = "roster/staff_rule_delete.html"
...
class StaffRuleCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = "roster/staff_rule_new.html"
    login_url = "login"
...
class StaffRuleShiftListView(LoginRequiredMixin, ListView):
    ...
    template_name = "roster/staff_rule_shift_list.html"
    login_url = "login"
...
class StaffRuleShiftDetailView(LoginRequiredMixin, DetailView):
    ...
    model = StaffRuleShift
    template_name = "roster/staff_rule_shift_detail.html"
    success_url = reverse_lazy("staff_rule_list")
    login_url = "login"
...
class StaffRuleShiftUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = "roster/staff_rule_shift_edit.html"
    success_url = reverse_lazy("staff_rule_list")
    login_url = "login"
...
class StaffRuleShiftDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = StaffRuleShift
    template_name = "roster/staff_rule_shift_delete.html"
    success_url = reverse_lazy("staff_rule_list")
    login_url = "login"
...
class StaffRuleShiftCreateView(LoginRequiredMixin, CreateView):
    ...
    model = StaffRuleShift
    template_name = "roster/staff_rule_shift_new.html"
    fields = ("shift", "position")
    login_url = "login"
...
class TimeSlotListView(LoginRequiredMixin, ListView):
    ...
    model = TimeSlot
    template_name = "roster/timeslot_list.html"
    login_url = "login"
...
class TimeSlotDetailView(LoginRequiredMixin, DetailView):
    ...
    model = TimeSlot
    template_name = "roster/timeslot_detail.html"
    login_url = "login"
...
class TimeSlotUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = "roster/timeslot_edit.html"
    login_url = "login"
...
class TimeSlotDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = TimeSlot
    template_name = "roster/timeslot_delete.html"
...
class TimeSlotCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = "roster/timeslot_new.html"
    login_url = "login"
...
class SelectRosterView(LoginRequiredMixin, FormView):
    ...
    template_name = "roster/select_roster.html"
...
class GenerateRosterView(LoginRequiredMixin, FormView):
    ...
    template_name = "roster/generate_roster.html"
...
class PreferenceListView(LoginRequiredMixin, ListView):
    ...
    model = Preference
    template_name = "roster/preference_list.html"
    login_url = "login"
...
class PreferenceDetailView(LoginRequiredMixin, DetailView):
    ...
    model = Preference
    template_name = "roster/preference_detail.html"
    login_url = "login"
...
class PreferenceUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = "roster/preference_edit.html"
    login_url = "login"
...
class PreferenceDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = Preference
    template_name = "roster/preference_delete.html"
...
class PreferenceCreateView(LoginRequiredMixin, CreateView):
    ...
    model = Preference
    template_name = "roster/preference_new.html"
...
class DayGroupListView(LoginRequiredMixin, ListView):
    ...
    model = DayGroup
    template_name = "roster/day_group_list.html"
    login_url = "login"
...
class DayGroupDetailView(LoginRequiredMixin, DetailView):
    ...
    model = DayGroup
    template_name = "roster/day_group_detail.html"
    login_url = "login"
...
class DayGroupUpdateView(LoginRequiredMixin, UpdateView):
    ...
    model = DayGroup
    fields = ("name",)
    template_name = "roster/day_group_edit.html"
    login_url = "login"
...
class DayGroupDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = DayGroup
    template_name = "roster/day_group_delete.html"
...
class DayGroupCreateView(LoginRequiredMixin, CreateView):
    ...
    model = DayGroup
    template_name = "roster/day_group_new.html"
    fields = ("name",)
    login_url = "login"
...
class DayGroupDayListView(LoginRequiredMixin, ListView):
    ...
    model = DayGroupDay
    template_name = "roster/day_group_day_list.html"
    login_url = "login"
...
class DayGroupDayDetailView(LoginRequiredMixin, DetailView):
    ...
    model = DayGroupDay
    template_name = "roster/day_group_day_detail.html"
    success_url = reverse_lazy("day_group_list")
    login_url = "login"
...
class DayGroupDayUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = "roster/day_group_day_edit.html"
    success_url = reverse_lazy("day_group_list")
    login_url = "login"
...
class DayGroupDayDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = DayGroupDay
    template_name = "roster/day_group_day_delete.html"
    success_url = reverse_lazy("day_group_list")
    login_url = "login"
...
class DayGroupDayCreateView(LoginRequiredMixin, CreateView):
    ...
    model = DayGroupDay
    template_name = "roster/day_group_day_new.html"
    fields = ("day",)
    login_url = "login"
...
class DayListView(LoginRequiredMixin, ListView):
    ...
    model = Day
    template_name = "roster/day_list.html"
    login_url = "login"
...
class DayDetailView(LoginRequiredMixin, DetailView):
    ...
    model = Day
    template_name = "roster/day_detail.html"
    login_url = "login"
...
class DayUpdateView(LoginRequiredMixin, UpdateView):
    ...
    model = Day
    fields = ("number",)
    template_name = "roster/day_edit.html"
    login_url = "login"
...
class DayDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = Day
    template_name = "roster/day_delete.html"
...
class DayCreateView(LoginRequiredMixin, CreateView):
    ...
    model = Day
    template_name = "roster/day_new.html"
    fields = ("number",)
    login_url = "login"
...
class DaySetCreateView(LoginRequiredMixin, FormView):
    ...
    template_name = "roster/day_set_new.html"
...
class StaffRequestListView(LoginRequiredMixin, ListView):
    ...
    template_name = "roster/staff_request_list.html"
    login_url = "login"
...
class StaffRequestUpdateView(LoginRequiredMixin, FormView):
    ...
    template_name = "roster/staff_request_update.html"
